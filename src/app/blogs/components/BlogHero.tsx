  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
        ...
        >
          <svg viewBox="0 0 200 200" fill="none" style={{ width: '100%', height: '100%' }}>
            ...
            <line x1="5" y1="100" x2="195" y2="100" stroke="white" strokeWidth="0.2" />
            <line x1="100" y1="5" x2="100" y2="195" stroke="white" strokeWidth="0.2" />
            <line x1="29" y1="29" x2="171" y2="171" stroke="white" strokeWidth="0.2" />
            <line x1="171" y1="29" x2="29" y2="171" stroke="white" strokeWidth="0.2" />
            <polygon
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 680, margin: '0 auto' }}>
        ...
        >
          Stories that{' '}
          <em style={{ color: '#D97235', fontStyle: 'italic', fontFamily: "var(--font-playfair), serif" }}>Awaken</em>
          {' & Inspire'}
        </h1>
        ...
        >
          Explore mindfulness, spirituality, personal growth, and the ancient wisdom of living
          fully.
        </p>

        {/* Stats row */}
        <div className="bh-stats" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 24 }}>
          ...
          <div className="bh-divider" style={{ width: 1, height: 32, background: 'rgba(250,247,242,0.15)' }} />
